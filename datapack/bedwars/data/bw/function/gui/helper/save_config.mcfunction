...
$scoreboard players set firstDiamond config $(firstDiamond)
$scoreboard players set firstEmerald config $(firstEmerald)
...
$scoreboard players set forceNoon config $(forceNoon)
